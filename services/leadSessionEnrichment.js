        ...
        messages: [
          {
            ...
            content: [
              ...
              'Вытащи только практический контекст: что клиент искал, аренда/покупка если ясно, бюджет/финансовый контекст, локации, тип объекта, важные пожелания, выбранный или последний показанный объект.',
              'Не пересказывай механику диалога: не пиши сколько было сообщений, что ассистент уточнял, какую кнопку клиенту предложили нажать или что клиенту нужно сделать дальше.',
              'Если заявка уже оставлена, следующий шаг всегда формулируй как действие менеджера: связаться с клиентом, обсудить запрос, объект или альтернативы.',
              'Не выдумывай факты. Если данных нет, так и напиши.',
              'Формат: 4-6 коротких пунктов без markdown-таблиц.'
            ].join(' ')
          },
          {
            role: 'user',
